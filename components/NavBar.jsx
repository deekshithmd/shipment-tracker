        ...
        >
          <ul className="justify-center items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
            {navigation.map((item, index) => {
              return (
                <li key={index} className="tex-gray-700 hover:text-gray-900">
          ...
          <div
            className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex
          ...
          >
            ...
            rounded-full md:inline-flex "
              ...
              justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gray-800 hover:bg-gray-700 activee:bg-gray-900
              rounded-full md:inline-flex"
              >
                Connect Wallet
                <Nav3/>
