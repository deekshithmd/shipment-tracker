        ...
        >
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <p className="text=[15px] text-gray-600">
              Tex explaining creating and tracking shipment using this tracker
            </p>
            <form onSubmit={(e) => e.preventDefault()}>
              <div className="relative mt-3">
                <input
                  ...
                  className="w-full pl-5 pr-3 py-2 text-gray-500 bg-transaprent
            ...
            font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500
