    ...
    <div className="max-w-screen-xl mx-auto px-4 md:px-8">
      <div className="items-start justify-between md:flex">
        <div className="max-w-lg">
          <h3 className="ext-gray-800 text-xl font-bold sm:text-2xl">
            Create Tracking
          </h3>
          <p className="text-gray-600 mt-2">
            Shipment tracking is created here to track
          </p>
        </div>
        <div className="mt-3 md:mt-0">
          ...
          font-medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900
